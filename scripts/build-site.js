...
function renderCategoryProductGrid(data) {
  ...
  data.products.forEach(function (product) {
    ...
    if (/^ldw/.test(product.slug) || product.slug === 'prm-80a' || product.slug === 'prm-82u' || product.slug === 'prm-150a' || product.slug === 'prm-125a' || product.slug === 'wj-72' || product.slug === 'wj-195' || product.slug === 'wj-88' || product.slug === 'wj-91' || product.slug === 'wj-110' || product.slug === 'wj-170') {
