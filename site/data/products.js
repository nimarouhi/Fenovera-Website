...
module.exports = [
...

  {
    ...
    materialLabel: 'Aluminum', typeLabel: 'Window',
    offeringStatus: 'current', publicationStatus: 'draft', verificationStatus: 'partial',
    seoTitle: 'PRM-140 Series Aluminum Hung Window | Fenovera',
    description: 'Aluminum single and double hung windows with a 140 mm frame, available with or without thermal break. NFRC energy performance documentation available. Contact Fenovera for specifications and pricing.',
    heroIntro: 'Aluminum single or double hung window with 140 mm frame. Available with or without thermal break. NFRC energy performance documentation available. Contact us for specifications, pricing, and availability.',
    heroImage: { src: '/img/al-prm83a-window-hero.jpg', alt: 'PRM-140 Series aluminum hung window in bright bedroom with garden view', role: 'hero', rightsVerified: false, productProvenanceVerified: true, sourceDocument: 'Prima aluminum catalog (Aluminum Windows and doors catalog from PRIMA.pdf), p.14' },
    keyFeatures: [
      '140 mm frame in single or double hung configuration',
      'Available with or without thermal break',
    ...
    hardware: null, certifications: ALUMINUM_CERTIFICATIONS_NFRC, documents: [],
    specificationGroups: [
      { label: 'Hung', rows: [
        { label: 'Item No',           value: 'PRW-140-01',                        status: 'confirmed' },
        { label: 'Frame width',       value: '140 mm',                            status: 'confirmed' },
        { label: 'Profile thickness', value: '1.4 / 1.6 mm',                      status: 'confirmed' },
        { label: 'Glass',             value: '5+12A+5 mm insulated tempered',      status: 'confirmed' },
...

  {
    ...
    description: 'Slim-profile aluminum sliding doors with a 132 mm frame, 4-panel and pocket configurations. Max leaf 2500 × 6096 mm, 500 kg per leaf. Contact Fenovera for pricing.',
...

  {
    ...
    description: 'The LU-E80s Urban Grove features a natural wood interior with aluminum exterior cladding. NFRC-certified. Six wood species and ten interior finish options.',
    heroIntro: 'Aluminum-wood clad tilt-turn window with warm interior aesthetics. The LU-E80s Urban Grove combines a natural wood interior (six species, ten finish options) with weather-resistant aluminum exterior cladding. NFRC-certified. Explore the matching <a href="/products/doors/wood-clad/lu-e80s-ls/">LU-E80s Lift Sliding Door</a>. Contact us for specifications, pricing, and availability.',
...

  {
    ...
    description: 'The LU-IU-CO Iconix US is an aluminum-wood clad crank-out casement window with NFRC-certified energy performance. Natural wood interior in six species with AAMA-verified AkzoNobel powder-coated aluminum exterior.',
    heroIntro: 'Aluminum-wood clad crank-out casement window. The LU-IU-CO Iconix US features natural wood interior (six species) with AAMA-verified AkzoNobel powder-coated aluminum exterior cladding. NFRC-certified. Full divided light grille option available for traditional aesthetics. Contact us for specifications, pricing, and availability.',
...

  {
    ...
    heroIntro: 'Aluminum-wood clad lift-and-slide door combining warmth with performance. The LU-E80s-LS Urban Grove features natural wood interior cladding paired with an aluminum exterior for weather resistance. NFRC-certified. Single leaf up to 7 feet wide. Explore the matching <a href="/products/windows/wood-clad/lu-e80s/">LU-E80s Tilt-Turn Window</a>. Contact us for specifications, pricing, and availability.',
